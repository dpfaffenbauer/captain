...
import { GitOpsApp, listGitOpsApps, triggerSync } from '../../../src/kube/gitops';
...
export default function GitOpsScreen() {
  ...
  const openApp = (app: GitOpsApp) => {
    router.push({
      ...
      params: {
        id,
        group: app.type.group,
        version: app.type.version,
        plural: app.type.plural,
        kind: app.type.kind,
        namespaced: app.type.namespaced ? '1' : '0',
        verbs: app.type.verbs.join(','),
        name: app.name,
